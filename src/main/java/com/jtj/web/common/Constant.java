...
/**
 * Created by MrTT (jiang.taojie@foxmail.com) 2017/1/22.
 */
public class Constant {
	...
	public enum OperationType {
		ADD(1, "记录"), BORROW(2, "借"), RETURN(3, "还"), LOSE(4, "丢失"), MAINTENANCE(5, "维修"), ABANDONED(6, "作废"),
		PAN(7, "盘点");
	...
	public enum AssetStatus {
		NORMAL(1, "正常"), BORROW(2, "租借"), MAINTENANCE(3, "维修"), ABANDONED(4, "报废");
	...
	public enum StockTakeItemStatus {
		HANDLING(1, "待处理"), NORMAL(2, "正常"), ABNORMAL(3, "异常");
